...
import {
    ACTION_SELECT_ORDER, MESSAGE_SERVER_ERROR, MESSAGE_UNAUTHORIZED, PAGE_LOG_IN,
    PAGE_ORDER_DETAIL, SESSION_ORDER, SESSION_USER,
    TABLE_INI_PAGE_NUM,
    TABLE_RECORD_PER_PAGE, UNAUTHORIZED_CODE, WAIT_EXECUTE
