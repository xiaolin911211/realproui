...
import {ContextOrder} from "../../contexts/context";
        ...
        <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
            ...
            <div className="flex justify-start item-start space-y-2 flex-col">
                <h1 className="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">Order
                    #13432</h1>
                <p className="text-base dark:text-gray-300 font-medium leading-6 text-gray-600">21st Mart 2021 at
                    10:34 PM</p>
            </div>
            <div
                    ...
                    <div
                            ...
                            <div
                                ...
                                <div className="w-full flex flex-col justify-start items-start space-y-8">
                                    ...
                                    <div className="flex justify-start items-start flex-col space-y-2">
                                        ...
                                        <p className="text-sm dark:text-white leading-none text-gray-800"><span
                                            className="dark:text-gray-400 text-gray-300">Color: </span> Light Blue
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div className="w-full md:w-40">
                                ...
                                <img className="w-full md:hidden" src="https://i.ibb.co/BwYWJbJ/Rectangle-10.png"
                                     alt="dress"/>
                            </div>
                            <div
                            ...
                            <div
                                ...
                                <div className="flex justify-start items-start flex-col space-y-2">
                                    <p className="text-base dark:text-white font-semibold leading-4 text-left text-gray-800">David
                                        Kent</p>
                                    <p className="text-sm dark:text-gray-300 leading-5 text-gray-600">10 Previous
                                        Orders</p>
                                </div>
                            </div>
